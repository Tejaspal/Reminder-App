...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, TableViewCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        toDoItems.append(ToDoItem(text: "Com Sci Hw"))
        toDoItems.append(ToDoItem(text: "Chores"))
        toDoItems.append(ToDoItem(text: "Feed my dog"))
        toDoItems.append(ToDoItem(text: "Physics Hw"))
        toDoItems.append(ToDoItem(text: "Study for Chem Test"))
        toDoItems.append(ToDoItem(text: "Violin"))
        toDoItems.append(ToDoItem(text: "Gym"))
        toDoItems.append(ToDoItem(text: "master Swift"))
        toDoItems.append(ToDoItem(text: "Dinner with Dad"))
        toDoItems.append(ToDoItem(text: "Finish IA"))
        toDoItems.append(ToDoItem(text: "Hair Cut"))
        toDoItems.append(ToDoItem(text: "Tutoring"))
    }
